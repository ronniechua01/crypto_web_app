...
const NavBar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
        ...
        <div className={nav ? 'fixed left-0 top-0 w-[50%] border-r border-r-gray-900 h-full bg-[#232D3F] ease-in-out duration-500' : 'fixed left-[-100%] top-0 w-[60%] border-r border-r-gray-900 h-full bg-[#232D3F]'}>
